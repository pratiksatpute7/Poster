...
def calculate_relevance_score(self, judge):
        ...
        This function uses the cosine similarity between the judge's research area 
        and the poster's abstract to determine relevance.
        ...
        """
        # Combine judge's department or research area and the poster's abstract for comparison
        judge_research_area = judge.profile_details
        poster_abstract = self.abstract
...
def assign_judges_to_posters(judges_df, posters_df):
    ...
    for _, poster in posters_df.iterrows():
        ...
        for judge in judges_list:
            score = calculate_relevance_score(judge, poster)
